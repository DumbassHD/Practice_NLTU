<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Games.aspx.cs" 
    Inherits="MyProject1.Pages.Admin.Games" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:ListView ID="ListView1" ItemType="MyProject1.Models.Game" SelectMethod="GetGames"
        DataKeyNames="GameId" UpdateMethod="UpdateGame" DeleteMethod="DeleteGame"
        InsertMethod="InsertGame" InsertItemPosition="LastItem" EnableViewState="false" runat="server">
        <LayoutTemplate>
        ...
        <EditItemTemplate>
            <tr>
                ...
                <td>
                    <asp:Button ID="Button3" CommandName="Update" Text="Обновити" runat="server" />
